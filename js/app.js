(() => {
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            ...
            formValidate.formClean(form);
            formLogging(`Formulář byl odeslán!`);
        }
    ...
    function initSlidersServices() {
        if (document.querySelector(".services-swiper")) new swiper_core_Swiper(".services-swiper", {
    ...
    function initSlidersTestimonials() {
        if (document.querySelector(".testimonials__slider")) new swiper_core_Swiper(".testimonials__slider", {
            ...
            on: {
                init: function() {
                    ...
                    document.querySelector(".testimonials__referens span").textContent = totalSlides;
                }
            }
        });
    }
